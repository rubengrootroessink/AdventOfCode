...
for i in range(10000000):
    if infected[curr_loc] == '.':
        curr_dir = turn(curr_dir, 'left')
        infected[curr_loc] = 'W'

    elif infected[curr_loc] == '#':
        curr_dir = turn(curr_dir, 'right')
        infected[curr_loc] = 'F'

    elif infected[curr_loc] == 'W':
        infected[curr_loc] = '#'
        bursts += 1

    elif infected[curr_loc] == 'F':
        curr_dir = turn(curr_dir, 'reverse')
        infected[curr_loc] = '.'
