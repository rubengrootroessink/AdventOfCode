...
while True:
    ...
    if addr != -1 and addr != 255:
        ...
        if is_network_idle():
            ...
            if idle_count > 1000: # Trial and error
                if prev_y and prev_y == last_y:
                    print(last_y)
                    break
                prev_y = last_y
                
                comps[0].input_list.append(last_x)
                comps[0].input_list.append(last_y)
